...
class Mage_Newsletter_Model_Subscriber extends Mage_Core_Model_Abstract
{
    ...
    public function subscribe($email)
    {
        ...
        Mage::dispatchEvent('subscriber_emailforge_generic', array('customer_id' => $customerSession->getCustomerId(), 'email' => $email));
    ...
    public function subscribeCustomer($customer)
    {
       ...
       if ($customer->isConfirmationRequired() && ($customer->getConfirmation() != $customer->getPassword())) {
        ...
        Mage::dispatchEvent('subscriber_emailforge_customer', array('customer' => $customer, 'email' => $email));
